...
export default function InteractiveAvatarBancochile() {
  ...
  const [knowledgeId, setKnowledgeId] = useState<string>(
    "73cb5e8bd85447d8954253639b406057",
  ); // Banco de Chile
  const [avatarId, setAvatarId] = useState<string>(
    "Silas_CustomerSupport_public",
  ); // Hombre Soporte
  const [language, setLanguage] = useState<string>("es");
  const [voiceId, setVoiceId] = useState<string>(
    "05e192129b6b466493886273f8c23f78",
  ); // Pablo
  ...
  async function startSession() {
    ...
    try {
      ...
      const welcomeMessage =
        "¡Hola! Soy Fabián, tu asistente virtual de Banco de Chile. Es un gusto conocerte. Estoy aquí para ayudarte";
            ...
            <div className="h-full justify-center items-center flex flex-col gap-3 w-[400px] self-center">
              ...
              <div className="text-center">
                ...
                <p className="text-blue-600 text-xs leading-relaxed max-w-xs mx-auto">
                  Tu asistente virtual especializado en educación financiera y
                  beneficios FAN.
                </p>
              </div>
