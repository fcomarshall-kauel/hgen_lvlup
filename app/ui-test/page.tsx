...
export default function UITestPage() {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        const randomResponse =
          avatarResponses[Math.floor(Math.random() * avatarResponses.length)];
  ...
  const startSession = async () => {
    ...
    addToHistory(
      "avatar",
      "¡Hola! Bienvenido al simulador. Soy Tara, tu asistente virtual de la UTA.",
    );
                  ...
                  <div className="h-full justify-center items-center flex flex-col gap-3 w-[400px] self-center">
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-purple-600 text-xs leading-relaxed max-w-xs mx-auto">
                        Prueba todos los estados de conversación sin usar la API
                        real.
                      </p>
                    </div>
        ...
        <aside className="w-80 bg-white border-l border-gray-200 p-4 overflow-y-auto">
          <div className="space-y-4">
            <div className="text-center">
              ...
              <div className="w-full h-0.5 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full" />
            </div>
              ...
              <CardBody className="p-3">
                ...
                <div className="space-y-1 text-xs">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span
                      className={
                        isVoiceChatActive ? "text-green-600" : "text-gray-500"
                      }
                    >
                  ...
                  <div className="flex justify-between">
                    ...
                    <span
                      className={
                        isUserTalking ? "text-red-600" : "text-gray-500"
                      }
                    >
                  ...
                  <div className="flex justify-between">
                    ...
                    <span
                      className={
                        isAvatarTalking ? "text-blue-600" : "text-gray-500"
                      }
                    >
              ...
              <CardBody className="p-3">
                ...
                <div className="space-y-2">
                  ...
                  <Button
                    ...
                    color="warning"
                    disabled={
                      !isUserTalking && !isAvatarTalking && !isProcessing
                    }
                    size="sm"
                    variant="flat"
                    onClick={() => {
